...
void TKesusGRpcService::SetupIncomingRequests(NYdbGrpc::TLoggerPtr logger) {
    ...
    using NGRpcService::TAuditModeFlags;
...
#define ADD_REQUEST(NAME, IN, OUT, CB, AUDIT_MODE_FLAGS) \
            ...
            [this](NYdbGrpc::IRequestContextBase* reqCtx) { \
                ...
                ActorSystem_->Send(GRpcRequestProxyId_, \
                    new NGRpcService::TGrpcRequestOperationCall<Ydb::Coordination::IN, Ydb::Coordination::OUT> \
                        (reqCtx, &CB, NGRpcService::TRequestAuxSettings{RLSWITCH(TRateLimiterMode::Rps), nullptr, AUDIT_MODE_FLAGS})); \
            }, \
    ...
    ADD_REQUEST(CreateNode, CreateNodeRequest, CreateNodeResponse, NGRpcService::DoCreateCoordinationNode, TAuditModeFlags::DatabaseApi | TAuditModeFlags::ModifyingOrCriticalApi);
    ADD_REQUEST(AlterNode, AlterNodeRequest, AlterNodeResponse, NGRpcService::DoAlterCoordinationNode, TAuditModeFlags::DatabaseApi | TAuditModeFlags::ModifyingOrCriticalApi);
    ADD_REQUEST(DropNode, DropNodeRequest, DropNodeResponse, NGRpcService::DoDropCoordinationNode, TAuditModeFlags::DatabaseApi | TAuditModeFlags::ModifyingOrCriticalApi);
    ADD_REQUEST(DescribeNode, DescribeNodeRequest, DescribeNodeResponse, NGRpcService::DoDescribeCoordinationNode, TAuditModeFlags::DatabaseApi);
