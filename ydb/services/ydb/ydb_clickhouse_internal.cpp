...
#define ADD_REQUEST(NAME, IN, OUT, CB, AUDIT_MODE_FLAGS) \
        ...
        [this](NYdbGrpc::IRequestContextBase *ctx) { \
            ...
            ActorSystem_->Send(GRpcRequestProxyId_, \
                new NGRpcService::TGrpcRequestOperationCall<Ydb::ClickhouseInternal::IN, Ydb::ClickhouseInternal::OUT> \
                    (ctx, &CB, NGRpcService::TRequestAuxSettings{RLSWITCH(NGRpcService::TRateLimiterMode::Rps), nullptr, AUDIT_MODE_FLAGS})); \
    ...
    ADD_REQUEST(Scan, ScanRequest, ScanResponse, DoReadColumnsRequest, TAuditModeFlags::DatabaseApi);
    ADD_REQUEST(GetShardLocations, GetShardLocationsRequest, GetShardLocationsResponse, DoGetShardLocationsRequest, TAuditModeFlags::DatabaseApi);
    ADD_REQUEST(DescribeTable, DescribeTableRequest, DescribeTableResponse, DoKikhouseDescribeTableRequest, TAuditModeFlags::DatabaseApi);
    ADD_REQUEST(CreateSnapshot, CreateSnapshotRequest, CreateSnapshotResponse, DoKikhouseCreateSnapshotRequest, TAuditModeFlags::DatabaseApi | TAuditModeFlags::ModifyingOrCriticalApi);
    ADD_REQUEST(RefreshSnapshot, RefreshSnapshotRequest, RefreshSnapshotResponse, DoKikhouseRefreshSnapshotRequest, TAuditModeFlags::DatabaseApi | TAuditModeFlags::ModifyingOrCriticalApi);
    ADD_REQUEST(DiscardSnapshot, DiscardSnapshotRequest, DiscardSnapshotResponse, DoKikhouseDiscardSnapshotRequest, TAuditModeFlags::DatabaseApi | TAuditModeFlags::ModifyingOrCriticalApi);
#undef ADD_REQUEST
}
