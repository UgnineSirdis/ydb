...
#define ADD_REQUEST(NAME, CB, AUDIT_MODE_FLAGS) \
    ...
    ADD_REQUEST(WhoAmI, &DoWhoAmIRequest, TAuditModeFlags::DatabaseApi)
    ADD_REQUEST(NodeRegistration, &DoNodeRegistrationRequest, TAuditModeFlags::ClusterApi | TAuditModeFlags::ModifyingOrCriticalApi)
