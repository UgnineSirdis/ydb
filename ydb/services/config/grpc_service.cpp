...
void TConfigGRpcService::SetupIncomingRequests(NYdbGrpc::TLoggerPtr logger) {
    ...
    SETUP_BS_METHOD(ReplaceConfig, DoReplaceConfig, Rps, CONFIG_REPLACECONFIG, TAuditModeFlags::ClusterApi | TAuditModeFlags::ModifyingOrCriticalApi);
    SETUP_BS_METHOD(FetchConfig, DoFetchConfig, Rps, CONFIG_FETCHCONFIG, TAuditModeFlags::ClusterApi);
    SETUP_BS_METHOD(BootstrapCluster, DoBootstrapCluster, Rps, CONFIG_BOOTSTRAP, TAuditModeFlags::ClusterApi | TAuditModeFlags::ModifyingOrCriticalApi);
