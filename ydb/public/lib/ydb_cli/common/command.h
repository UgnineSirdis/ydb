...
public:
    ...
    public:
        ...
        TOauth2TokenExchangeParams BuildOauth2TokenExchangeParams() const; // Builds final TOauth2TokenExchangeParams from Oauth2TokenExchangeParams, SubjectJwtTokenSourceParams, ActorJwtTokenSourceParams and IamEndpoint
